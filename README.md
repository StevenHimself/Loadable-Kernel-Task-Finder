...
A task finder written in kernel space to detect if a process is running within your Linux environment. If so, it displays infromation about the process such as its name and identification number (ID). 
